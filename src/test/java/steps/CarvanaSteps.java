...
//
    ...
    public void userHoversOverOnMenuItem(String financingHover) {
        ...
        Waiter.waitForVisibilityOfElement(driver,carvanaMainPage.financialButton,30);
    ...
    public void userSelectsAs(String scoreText, String score) {
        switch (scoreText) {
            case "What’s Your credit Score?":
                DropdownHandler.selectOptionByIndex(carvanaFinancialPage.creditScoreBox, 0);
                break;
            case "Choose Your Loan Terms":
                Waiter.pause(2);
                DropdownHandler.selectOptionByIndex(carvanaFinancialPage.loanTerm,1);
                break;
                default:
                throw new NotFoundException("The button text is not defined properly in the feature file!!!");
        }
